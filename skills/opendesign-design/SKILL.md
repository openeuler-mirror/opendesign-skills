...
| [OCarousel](references/components/carousel.md) | 幻灯片指示器 | [OScrollbar](references/components/scrollbar.md) | 滚动条 |
| [OCheckbox](references/components/checkbox.md) | 复选框 | [OSearch](references/components/search.md) | 搜索框 |
| [ODivider](references/components/divider.md) | 分割线 | [OStep](references/components/step.md) | 步骤条 |
| [ODropdown](references/components/dropdown.md) | 下拉菜单 | [OSwitch](references/components/switch.md) | 开关 |
