...
| 图标色值 | `color-white` | 白色勾选符号 |
| 背景色值 | `color-success1` | 绿色背景，表示成功完成 |
| 标题字重 | Regular | 常规字重 |
| 标题字号 | 16px | 标准字号 |
| 标题色值 | `color-info2` | 深灰色文字 |
...
| 图标容器尺寸 | 32×32px | 圆形容器 |
| 数字字号 | 20px | 序号大小 |
| 数字色值 | `color-white` | 白色数字 |
| 背景色值 | `color-primary1` | 品牌蓝色背景 |
| 标题字重 | **SemiBold (600)** | 加粗强调 |
| 标题字号 | 16px | 标准字号 |
| 标题色值 | `color-primary1` | 品牌蓝文字，与图标呼应 |
...
| 图标容器尺寸 | 32×32px | 圆形容器 |
| 数字字号 | 20px | 序号大小 |
| 数字色值 | `color-white` | 白色数字（或浅灰） |
| 背景色值 | `color-primary4` | 浅蓝色/灰色背景 |
| 标题字重 | Regular | 常规字重 |
| 标题字号 | 16px | 标准字号 |
| 标题色值 | `color-info3 / color-info4` | 浅灰色文字 |
...
| 连接区间 | 颜色 | 说明 |
|---------|------|------|
| 已完成 → 进行中 | `color-primary1` | 品牌蓝，强调已打通的路径 |
| 进行中 → 未开始 | `color-control4` | 浅灰色，表示待完成的路径 |
...
|------|-------------|-------------|----------|
| **进行中** | `color-primary1` | `color-primary1` | ⭐⭐⭐ 最高 |
| **已完成** | `color-success1` | `color-info2` | ⭐⭐ 中等 |
| **未开始** | `color-primary4` | `color-info4` | ⭐ 最低 |
