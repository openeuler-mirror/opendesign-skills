...
- **一级色值**：`#000000 80%` (`color-info2`)
- **图标**：无前缀图标（仅箭头图标）

**二级菜单项**
- **文字**：二级字号 14px (Regular)
- **二级色值**：`#000000 80%` (`color-info2`)
- **背景**：透明
...
- **文字**：二级字号 14px (Regular)
- **二级色值**：`#000000 80%` (`color-info2`)
- **背景色值**：`#EBF1FA` (`color-control2-light`)
...
- **图标**：
  - 大小：24×24px
  - 色值：`#000000 80%`, `rgba(0, 0, 0, 0.8)` (`color-info2`)
...
- **二级色值**：`#002FA7` (`color-primary1`)
- **背景色值**：`#CEDBF5` (`color-control3-light`)
- **图标**：
  - 大小：24×24px
  - 色值：`#002FA7` (`color-primary1`)

**一级按下**
- **文字**：一级字号 16px (**SemiBold**)
- **一级色值**：`#002FA7` (`color-primary1`)
- **背景色值**：`#CEDBF5` (`color-control3-light`)
- **图标**：
  - 大小：24×24px
  - 色值：`#002FA7` (`color-primary1`)
...
**一级禁用**
- **文字**：一级字号 16px (Regular)
- **一级色值**：`#000000 40%` (`color-info4`)
- **图标**：
  - 大小：24×24px
  - 色值：`#000000 40%`, `rgba(0, 0, 0, 0.4)` (`color-info4`)
- **背景**：透明

**二级禁用**
- **文字**：二级字号 14px (Regular)
- **二级色值**：`#000000 40%` (`color-info4`)
- **背景**：透明
...
|------|------|------|------|--------|--------|---------|--------|
| Default | Level 1 | 16px | Regular | `color-info2` | 透明 | — | — |
| Default | Level 2 | 14px | Regular | `color-info2` | 透明 | — | — |
| Hover | Level 1 | 16px | Regular | `color-info2` | `color-control2-light` | 24×24px | `color-info2` |
| Hover | Level 2 | 14px | Regular | `color-info2` | `color-control2-light` | — | — |
| Press | Level 1 | 16px | **SemiBold** | `color-primary1` | `color-control3-light` | 24×24px | `color-primary1` |
| Press | Level 2 | 14px | **SemiBold** | `color-primary1` | `color-control3-light` | 24×24px | `color-primary1` |
| Actived | Level 1 | 16px | **SemiBold** | `color-primary1` | `color-control3-light` | 24×24px | `color-primary1` |
| Actived | Level 2 | 14px | **SemiBold** | `color-primary1` | `color-control3-light` | 24×24px | `color-primary1` |
| Disabled | Level 1 | 16px | Regular | `color-info4` | 透明 | 24×24px | `color-info4` |
| Disabled | Level 2 | 14px | Regular | `color-info4` | 透明 | — | — |
